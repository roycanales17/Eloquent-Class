<?php
	...
	class Blueprint
	{
		...
		protected bool $orderBy=false,$whereCondition=false,$selectColumn=false,$tableStatus=false,$offsetStatus=false,$limitStatus=false;

		protected array $binds=[],$update_binds=[];

		protected string $table='',$query='',$temp_grouped='',$connectTable='';
